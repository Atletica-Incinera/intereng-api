...
import { TeamManagerValidationStrategy } from './team-manager-validation.strategy';
...
export * from './team-manager-validation.strategy';
...
export const ROLE_VALIDATION_STRATEGIES: Record<EditionStaffRoleType, RoleValidationStrategy> = {
  ...
  [EditionStaffRoleType.TEAM_MANAGER]: new TeamManagerValidationStrategy(),
};
